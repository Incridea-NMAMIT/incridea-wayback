...
import { archiveEvents } from "@/src/archive/events";
import type { Event as ArchiveEvent } from "@/src/generated/generated";
...
const Events: NextPage<{ data: ArchiveEvent[] }> = ({
  data,
}) => {
...
export async function getStaticProps() {
  return { props: { data: archiveEvents } };
}
