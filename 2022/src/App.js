...
function App() {
  ...
  return <>
    <div className="group fixed inset-x-0 top-0 z-[9999] h-10">
      <aside
        className="absolute inset-x-0 top-0 border-b border-amber-300/40 bg-black/95 px-3 py-2 text-center text-xs font-medium tracking-wide text-[#f5e6c8] shadow-lg backdrop-blur transition-transform duration-300 ease-out group-hover:-translate-y-full group-focus-within:translate-y-0"
        role="status"
      >
