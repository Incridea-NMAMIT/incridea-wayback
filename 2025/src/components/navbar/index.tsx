  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed font-life-craft tracking-wider w-full top-11 bg-white/10 backdrop-blur-2xl h-16 lg:flex hidden items-center justify-center rounded-full z-50"
      >
