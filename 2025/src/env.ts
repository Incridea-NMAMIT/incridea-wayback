...
export const env = createEnv({
   ...
   */
  // This is an immutable, read-only archive. It deliberately has no live API,
  // auth, payments, or upload credentials; its Apollo boundary serves local
  // archive data instead. Allow normal `next dev` as well as archive builds
  // without pretending those retired integration variables still exist.
  skipValidation: process.env.SKIP_ENV_VALIDATION !== "false",
  /**
