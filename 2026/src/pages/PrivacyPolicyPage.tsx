...
const PrivacyPage = () => {
  return (
    <>
      ...
      <div className="min-h-screen px-4 pb-28 md:pb-16 pt-8 sm:pt-10 md:px-6 md:mx-48">
        <SEO
          title="Privacy Policy"
          description="Read the privacy policy of Incridea'26."
          url="/privacy-policy"
        />
        <LiquidGlassCard className="mx-auto flex w-full max-w-6xl flex-col gap-8 rounded-2xl border border-slate-800 p-6 md:p-10 shadow-xl">
          <div className="md:p-10 ">
            <div className="flex flex-initial flex-col gap-4 md:pb-10  border-b border-slate-800/50">
            ...
            <section className="flex  mt-12 flex-col gap-3">
              ...
              <p className="text-slate-300 text-sm sm:text-sm lg:text-base leading-relaxed">
            ...
            <section className="flex md:mt-12 flex-col gap-3 border-t border-slate-800/50 pt-10">
              <p className="text-base sm:text-base lg:text-lg font-semibold text-purple-400">
