...
const TermsAndConditionsPage = () => {
  return (
    <div className="min-h-screen text-white relative max-w-6xl md:mx-48 px-4 pb-16 pt-10 md:px-6">
      <SEO
        title="Terms and Conditions"
        description="Read the terms and conditions of Incridea'26."
        url="/terms"
      />
            ...
            <div className="md:p-10">
              ...
              <div className="flex flex-col gap-8 text-slate-300 text-sm sm:text-sm lg:text-base leading-relaxed">
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    This website is operated by NMAM Institute of Technology. Throughout the site, the terms “we”, “us” and “our” refer to NMAM Institute of Technology. NMAM Institute of Technology offers this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.
                  </p>
                  <p>
                    By visiting our site and/or participating in our college fest Incridea '26, you engage in our “Service” and agree to be bound by the following terms and conditions (“Terms of Service”, “Terms”), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of the site, including, without limitation, students, college staff, and all other participants who browse the page.
                  </p>
                  <p>
                    Please read these Terms of Service carefully before accessing or participating in Incridea '26. By accessing or participating in any part of the event, you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions of this agreement, then you may not participate in the event. If these Terms of Service are considered an offer, acceptance is expressly limited to these Terms of Service.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-lg sm:text-lg lg:text-xl font-bold text-sky-100 mb-3">
                    SECTION 1 - INCRIDEA '26 PARTICIPATION TERMS
                  </h2>
                  <p>
                    You may not use our event platform for any illegal or unauthorized purpose nor may you, in the use of the Service, violate any laws in your jurisdiction (including but not limited to copyright laws).
                  </p>
                  <p>
                  ...
                  <p>
                    A breach or violation of any of the Terms will result in immediate disqualification from the event and may lead to further consequences as deemed necessary by NMAM Institute of Technology.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-lg sm:text-lg lg:text-xl font-bold text-sky-100 mb-3">
                    SECTION 2 - GENERAL CONDITIONS FOR INCRIDEA '26 PARTICIPATION
                  </h2>
                  <p>
                    We reserve the right to refuse participation to anyone for any reason at any time, including but not limited to those who violate the terms and conditions stated in Section 1.
                  </p>
                  <p>
                    You understand that any content you provide on our event platform, including but not limited to text, images, and videos, may be publicly visible to other participants and may be used by NMAM Institute of Technology for promotional purposes.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-lg sm:text-lg lg:text-xl font-bold text-sky-100 mb-3">
                    SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION FOR INCRIDEA '26 PARTICIPATION
                  </h2>
                  <p>
                    We, the student organizers, and college staff of NMAM Institute of Technology, strive to ensure that all information provided on the Incridea '26 event platform is accurate, complete, and timely. However, we cannot guarantee the accuracy, completeness, or timeliness of all information provided.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-lg sm:text-lg lg:text-xl font-bold text-sky-100 mb-3">
                    SECTION 4 - MODIFICATIONS TO INCRIDEA '26 AND REGISTRATION PRICES
                  </h2>
                  <p>
                    Prices for registration and events at Incridea '26, organized by NMAM Institute of Technology student organizers, are subject to change without notice.
                  </p>
                  <p>
                    We reserve the right at any time to modify or discontinue any aspect of Incridea '26 (or any part or content thereof) without notice at any time.
                  </p>
                  <p>
                    NMAM Institute of Technology student organizers and college staff shall not be liable to you or to any third-party for any modification, price change, suspension, or discontinuance of Incridea '26.
                  </p>
                </section>

                <section className="flex flex-col gap-3">
                  <h2 className="text-lg sm:text-lg lg:text-xl font-bold text-sky-100 mb-3">
                    SECTION 5 - EVENTS AND SERVICES AT INCRIDEA '26
                  </h2>
                  <p>
                    Certain events and services may be available exclusively through the Incridea '26 website, organized by NMAM Institute of Technology student organizers. These events and services may have limited capacities and are subject to availability.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    We reserve the right to refuse attendance or participation in any event or service organized by Incridea '26, held by NMAM Institute of Technology, to any person who has provided inaccurate, incomplete, or outdated registration or account information.
                  </p>
                  <p>
                    NMAM Institute of Technology student organizers and college staff reserve the right, in their sole discretion, to limit or cancel the attendance or participation of any person, from any geographic region or jurisdiction, and to limit or prohibit attendance or participation that, in our judgment, appear to be made by individuals who violate our policies or abuse the registration or account process.
                  </p>
                  <p>
                    You agree to provide current, complete, and accurate registration and account information for all events and services organized by Incridea '26. You agree to promptly update your account and other information, including your email address and payment information, so that we can complete your transactions and contact you as needed.
                  </p>
                </section>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    Incridea '26, held by NMAM Institute of Technology, may provide you with access to third-party tools over which we have no control or input.
                  </p>
                  <p>
                    You acknowledge and agree that Incridea '26 provides access to such tools "as is" and "as available" without any warranties, representations, or conditions of any kind and without any endorsement. We shall have no liability whatsoever arising from or relating to your use of optional third-party tools.
                  </p>
                  <p>
                    Any use by you of optional tools offered through Incridea '26 is entirely at your own risk and discretion, and you should ensure that you are familiar with and approve of the terms on which tools are provided by the relevant third-party provider(s).
                  </p>
                  <p>
                    Incridea '26 may also offer new services and/or features through the event (including the release of new tools and resources). Such new features and/or services shall also be subject to these Terms and Conditions.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    Certain content, products, and services available via Incridea '26, the college fest organized by student organizers of NMAM Institute of Technology, may include materials from third parties.
                  </p>
                  <p>
                    Third-party links on the Incridea '26 website may direct you to third-party websites that are not affiliated with the college staff. We, the college staff, are not responsible for examining or evaluating the content or accuracy, and we do not warrant and will not have any liability or responsibility for any third-party materials or websites, or for any other materials, products, or services of third parties.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    If, at our request, you send certain specific submissions related to Incridea '26, the college fest organized by student organizers of NMAM Institute of Technology (for example, contest entries), or without a request from us, you send creative ideas, suggestions, proposals, plans, or other materials, whether online, by email, by postal mail, or otherwise (collectively, "comments"), you agree that we may, at any time, without restriction, edit, copy, publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We, the college staff, are and shall be under no obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or (3) to respond to any comments.
                  </p>
                  <p>
                    We may, but have no obligation to, monitor, edit, or remove content related to Incridea '26 that we determine in our sole discretion are unlawful, offensive, threatening, libellous, defamatory, pornographic, obscene, or otherwise objectionable or violates any party’s intellectual property or these Terms of Service.
                  </p>
                  <p>
                    You agree that your comments related to Incridea '26 will not violate any right of any third-party, including copyright, trademark, privacy, personality, or other personal or proprietary right. You further agree that your comments will not contain libellous or otherwise unlawful, abusive, or obscene material or contain any computer virus or other malware that could in any way affect the operation of the Service or any related website. You may not use a false e-mail address, pretend to be someone other than yourself, or otherwise mislead us or third parties as to the origin of any comments. You are solely responsible for any comments you make related to Incridea '26 and their accuracy. We, the college staff, take no responsibility and assume no liability for any comments posted by you or any third-party related to Incridea '26.
                  </p>
                </section>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    Your submission of personal information through the Incridea '26 website is governed by our Privacy Policy. The student organizers and college staff take the privacy of our participants and attendees seriously and are committed to protecting their personal information. Please carefully review our Privacy Policy before submitting any personal information.
                  </p>
                </section>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    Occasionally, there may be information on the Incridea '26 website or in the Service that contains typographical errors, inaccuracies or omissions that may relate to event details, schedules, locations, pricing, promotions, offers, or any other related information. We reserve the right to correct any errors, inaccuracies, or omissions, and to change or update information without prior notice.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    We do not guarantee, represent, or warrant that your use of our service, i.e., the Incridea '26 event, will be uninterrupted, timely, secure, or error-free.
                  </p>
                  <p>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    In the event that any provision of these Terms of Service related to Incridea '26, held by NMAM Institute of Technology, is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service. Such determination shall not affect the validity and enforceability of any other remaining provisions that remain relevant to Incridea '26.
                  </p>
                </section>
                ...
                <section className="flex flex-col gap-3">
                  ...
                  <p>
                    These Terms of Service and any separate agreements whereby the student organizers or the college staff of Incridea '26, held by NMAM Institute of Technology, provide services for the fest, shall be governed by and construed in accordance with the laws of India and the jurisdiction of Karkala, Karnataka.
                  </p>
                </section>
                ...
                <section className="flex flex-col gap-3 border-t border-purple-200/20 pt-10">
                  ...
                  <p>
                    Any questions about the Terms of Service of Incridea '26, held by NMAM Institute of Technology, should be directed to the student organizers and college staff at the following contact information:
                  </p>
