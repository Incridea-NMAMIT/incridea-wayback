...
function ContactPage() {
  return (
    <>
      <SEO
        title="Contact Us - Incridea"
        description="Get in touch with the Incridea team at NMAMIT Nitte for queries regarding events, registrations, or sponsorships. Find our contact details and address here."
        url="/contact-us"
      />
        ...
        <div className="px-4 pb-16 pt-10 md:px-6 relative z-10">
          <div className="mx-auto flex max-w-7xl flex-col gap-8">
            ...
            <header className="space-y-3 text-center">
              ...
              <p className="mx-auto max-w-3xl text-base sm:text-base md:text-lg text-slate-100 drop-shadow-md">
            ...
            {/* Main Contact Card */}
            <LiquidGlassCard>
              <div className="grid gap-6 md:grid-cols-5 md:p-8">
                ...
                <div className="md:col-span-2 space-y-8 p-4 md:p-6 relative">
                  <div>
                    ...
                    <p className="text-slate-300 text-sm sm:text-sm lg:text-base">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-slate-300 text-xs sm:text-xs mb-1 uppercase font-bold tracking-wider">
                        Email
                      </p>
                      <a
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-1 text-sm sm:text-sm lg:text-base">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white text-sm sm:text-sm lg:text-base space-y-1">
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <a
                      href="https://linkedin.com/company/incridea-nmamit"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <div className="md:col-span-3 space-y-6 md:p-6">
                  ...
                  <div className="text-left">
                    <h3 className="text-base sm:text-base font-semibold mb-3 text-white uppercase tracking-wider">
                      University Information
                    </h3>
                    <div className="text-slate-300 text-sm sm:text-sm space-y-1">
                      <p>The off-campus center of Nitte DU</p>
