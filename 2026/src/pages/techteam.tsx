    ...
    <>
      ...
      <section className="flex flex-col items-center w-full pt-0 sm:pt-2 md:pt-4 lg:pt-6 pb-12 px-4">
        ...
        <div className="relative pt-20 -mt-24 lg:mt-0 flex flex-col items-center justify-center w-full">
          {}
          <motion.h1
            className="text-2xl min-[375px]:text-3xl sm:text-5xl md:text-6xl lg:text-8xl whitespace-nowrap sm:top-13 md:top-11 lg:top-4 top-17 text-center absolute font-bold w-full mt-12 bg-gradient-to-b from-white via-white to-transparent bg-clip-text text-transparent tracking-wider drop-shadow-md"
